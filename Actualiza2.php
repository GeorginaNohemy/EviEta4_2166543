...
$resultado = mysqli_query($con, "SELECT * FROM maestros WHERE Matricula = '$Matricula'"); // Consultamos el contenido de la tabla clientes
...
while ($row = mysqli_fetch_array($resultado)) { // Muestra el contenido del registro a editar
    ...
    echo "<tr>";
    echo "<td>Materia:</td>";
    echo "<td><input type='text' name='Materia' value='" . htmlspecialchars($row['Materia']) . "'></td></tr>";
}

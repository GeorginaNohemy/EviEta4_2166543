...
$Matricula = mysqli_real_escape_string($con, $_POST['Matricula']); // Escapamos el ID del cliente
$resultado = mysqli_query($con, "SELECT * FROM alumnos WHERE Matricula = '$Matricula'"); // Consultamos el contenido de la tabla clientes
...
while ($row = mysqli_fetch_array($resultado)) { // Muestra el contenido del registro a editar
    ...
    echo "<td><input type='text' name='Matricula' value='" . htmlspecialchars($row['Matricula']) . "' readonly></td></tr>";
    echo "<tr>";
    echo "<td>Nombre:</td>";
    echo "<td><input type='text' name='Nombre' value='" . htmlspecialchars($row['Nombre']) . "'></td></tr>";
    echo "<tr>";
    echo "<td>Apellido:</td>";
    echo "<td><input type='text' name='Apellido' value='" . htmlspecialchars($row['Apellido']) . "'></td></tr>";
    echo "<tr>";
    echo "<td>Semestre:</td>";
    echo "<td><input type='text' name='Semestre' value='" . htmlspecialchars($row['Semestre']) . "'></td></tr>";
}
echo "</table>";

...
<body>
<?php
    $con = mysqli_connect("localhost", "root", "", "coleguio_2165543") or die("Falla al conectar");
    $query = $con->query("SELECT * FROM coleguiaturas");
 
    echo "<h1>Consulta a la tabla de Coleguiatura</h1>";
    echo "<center><table>
<tr>
<th>Cuotar</th> 
<th>Semestre_a_Cursar</th> 
<th>Tipo_Programa</th>
<th>Preparatoria</th>
</tr>";
    $cont = 0;
    while ($row = mysqli_fetch_array($query)) {
        ...
        echo "<td>" . $row['Semestre_a_Cursar'] . "</td>"; 
        echo "<td>" . $row['Tipo_Programa'] . "</td>";
        echo "<td>" . $row['Preparatroria'] . "</td>";
        echo "</tr>";
        $cont++;
    }
    echo "</table><br>";
